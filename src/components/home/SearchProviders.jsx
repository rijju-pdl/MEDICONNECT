...
import { updateCityChosenHospital } from "../../stores/hospitalsSlice";
import {
...
} from "../../stores/providerSearchSlice";
...
export default function SearchProviders() {
  ...
  return (
    ...
    <div className="bg-white shadow-lg rounded-md p-4 md:p-5 flex flex-col gap-5 md:gap-6 xl:gap-8 ">
      {/*search by input*/}
